...
const Button = ({ className, variant, size, ...props }: any) => (
  <button 
    // CHANGED: bg-[#E0683D] -> bg-[#E2BC63]
    // CHANGED: hover:bg-[#c25730] -> hover:bg-[#c9a758] (a slightly darker gold for hover)
    className={`inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:opacity-50 disabled:pointer-events-none ring-offset-background bg-[#E2BC63] text-white hover:bg-[#c9a758] h-11 px-8 ${className}`} 
    {...props} 
  />
);
...
const Input = ({ className, ...props }: any) => (
  <input 
    // CHANGED: focus-visible:ring-[#E0683D] -> focus-visible:ring-[#E2BC63]
    className={`flex h-12 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E2BC63] disabled:cursor-not-allowed disabled:opacity-50 ${className}`} 
    {...props} 
  />
);
...
const Textarea = ({ className, ...props }: any) => (
  <textarea 
    // CHANGED: focus-visible:ring-[#E0683D] -> focus-visible:ring-[#E2BC63]
    className={`flex min-h-[150px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E2BC63] disabled:cursor-not-allowed disabled:opacity-50 ${className}`} 
    {...props} 
  />
);
// ==========================================
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <div className="relative h-[50vh] min-h-[400px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
          {/* CHANGED: text-[#E0683D] -> text-[#E2BC63] */}
          <p className={`text-[#E2BC63] font-bold tracking-wider uppercase mb-4 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Get In Touch
          </p>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      {/* CHANGED: bg-[#E0683D]/10 -> bg-[#E2BC63]/10 */}
                      <div className="w-12 h-12 rounded-lg bg-[#E2BC63]/10 flex items-center justify-center flex-shrink-0">
                        {/* CHANGED: text-[#E0683D] -> text-[#E2BC63] */}
                        <Mail className="w-5 h-5 text-[#E2BC63]" />
                      </div>
                      <div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="w-12 h-12 rounded-lg bg-[#E2BC63]/10 flex items-center justify-center flex-shrink-0">
                        {/* CHANGED: text-[#E0683D] -> text-[#E2BC63] */}
                        <Phone className="w-5 h-5 text-[#E2BC63]" />
                      </div>
                      <div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="w-12 h-12 rounded-lg bg-[#E2BC63]/10 flex items-center justify-center flex-shrink-0">
                        {/* CHANGED: text-[#E0683D] -> text-[#E2BC63] */}
                        <MapPin className="w-5 h-5 text-[#E2BC63]" />
                      </div>
                      <div>
